        ...
        success: function (data) {
            if (data.IsValid) {
                ...
                if (data.ValidFieldID != "") {
                    ...
                    if (data.FieldID == "Gender" || data.FieldID == "HealthStat" || data.FieldID == "ReportBit") {
                    ...
                    if (data.FieldID == "GoverID" || data.FieldID == "DistrictID" || data.FieldID == "DisTypeID" || data.FieldID == "LossClass" || data.FieldID == "LossGoverID" || data.FieldID == "LossDistrictID") {
...
function OpenModal() {
    ...
    document.getElementById('ModalRelation').innerText = document.getElementById('RelativeRel').value;
    ...
    document.getElementById('ModalChild').innerText = document.getElementById('ChildName').value;
    ...
    if (HS[2].checked == true)
        document.getElementById('ModalDisType').innerText = DisType;
    else
        document.getElementById('ModalDisType').innerText = "";
    document.getElementById('ModalCAge').innerText = document.getElementById('Age').value;
    document.getElementById('ModalLDate').innerText = document.getElementById('LossDate').value;
    document.getElementById('ModalLType').innerText = $('#LossClass option:selected').text();
    if (document.getElementById('inlineRadio3').checked == true)
        document.getElementById('ModalIsLost').innerText = "لا";
    if (document.getElementById('inlineRadio4').checked == true)
        document.getElementById('ModalIsLost').innerText = "نعم";
    if (document.getElementById('inlineRadio5').checked == true)
        document.getElementById('ModalIsLost').innerText = "لا اعرف";
    if (document.getElementById('inlineRadio4').checked == true)
        document.getElementById('ModalHowFind').innerText = document.getElementById('HowFind').value;
    else
        document.getElementById('ModalHowFind').innerText = "";
    document.getElementById('ModalLGover').innerText = $('#LossGoverID option:selected').text();
    document.getElementById('ModalLDis').innerText = $('#LossDistrictID option:selected').text();
    document.getElementById('ModalLAddress').innerText = document.getElementById('LossAddress').value;
   
    document.getElementById('ModalDes').innerText = document.getElementById('floatingTextarea2').value;
        ...
        success: function (data) {
            if (data.IsValid) {
                ...
                if (data.ValidFieldID != "") {
                    ...
                    if (data.FieldID == "DisTypeID" || data.FieldID == "LossClass" || data.FieldID == "LossGoverID" || data.FieldID == "LossDistrictID") {
                        $('#' + data.FieldID).siblings(".select2-container").css('border', '1px solid red');
                    }
                }
            }
...
function HowFindChange(input) {
    if (input.value == 1 && input.checked == true) {
        document.getElementById("HowFindDiv").style.display = "block";
    }
    else {
        document.getElementById("HowFindDiv").style.display = "none";
    }
}
...
function ValidationRefresh(inputid, validid, step) {
    ...
    if (inputid == "GoverID" || inputid == "DistrictID" || inputid == "DisTypeID" || inputid == "LossClass" || inputid == "LossGoverID" || inputid == "LossDistrictID") {
        $('#' + inputid).siblings(".select2-container").css('border', '');
    }

    if (inputid == "Gender" || inputid == "HealthStat" || inputid == "ReportBit") {
